...
- ⬜ 🟢 **Tester le PR Dependabot Next 15** — PR ouvert le 28/07 (branche `dependabot/npm_and_yarn/npm_and_yarn-5988e9b934`, Next 14.2.35 → 15.5.21) : corrigerait les 16 vulnérabilités « high » restantes (sans risque réel en export statique, déjà acté). Méthode : récupérer la branche, la rebaser sur main, `npm run build` + vérifier le rendu localement (saut majeur : React 19), puis merger le PR — ne jamais merger sans test local.
